...
class FeatureExtractor(nn.Module):
    ...
    def forward(self, graph, device):
        ...
        # NOTE to check whether the token is in the token2idx_dict.keys()
        vectorized_seqs = [[self.token2idx_dict[tok] for tok in seq if tok in self.token2idx_dict.keys()] for seq in seqs]
        ...
        dgl_graph.nodes[perm_idx].data['feat'] = ht.squeeze(0).cpu()
