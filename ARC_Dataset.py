...
class ARC_Dataset(Dataset):
    def __init__(self, folder, dataset="train", is_easy=True):
        ...
        if is_easy:
            if dataset == "train":
                hypo_graph_file = folder + "/ARC-Hypothesis-dict/ARC-Easy/ARC-Easy-Train-Hypothesis-dict.txt"
                supp_graph_file = folder + "/ARC-Supports-dict/ARC-Easy/ARC-Easy-Train-Supports-dict.txt"
                labels_file = folder + "/ARC-Labels/ARC-Easy/ARC-Easy-Train-Labels.jsonl"
            elif dataset == "dev":
                hypo_graph_file = folder + "/ARC-Hypothesis-dict/ARC-Easy/ARC-Easy-Dev-Hypothesis-dict.txt"
            ...
            if dataset == "train":
                hypo_graph_file = folder + "/ARC-Hypothesis-dict/ARC-Challenge/ARC-Challenge-Train-Hypothesis-dict.txt"
                supp_graph_file = folder + "/ARC-Supports-dict/ARC-Challenge/ARC-Challenge-Train-Supports-dict.txt"
                labels_file = folder + "/ARC-Labels/ARC-Challenge/ARC-Challenge-Train-Labels.jsonl"
            elif dataset == "dev":
                hypo_graph_file = folder + "/ARC-Hypothesis-dict/ARC-Challenge/ARC-Challenge-Dev-Hypothesis-dict.txt"
                supp_graph_file = folder + "/ARC-Supports-dict/ARC-Challenge/ARC-Challenge-Dev-Supports-dict.txt"
                labels_file = folder + "/ARC-Labels/ARC-Challenge/ARC-Challenge-Dev-Labels.jsonl"
            elif dataset == "test":
                hypo_graph_file = folder + "/ARC-Hypothesis-dict/ARC-Challenge/ARC-Challenge-Test-Hypothesis-dict.txt"    
                supp_graph_file = folder + "/ARC-Supports-dict/ARC-Challenge/ARC-Challenge-Test-Supports-dict.txt"
